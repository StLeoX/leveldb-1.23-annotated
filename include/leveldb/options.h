...
struct LEVELDB_EXPORT Options {
  ...
  // 如果为 true，则实现将对其正在处理的数据进行积极检查，如果检测到任何错误，则会提前停止。
  ...
  // Write Buffer Size，默认为 4M。这个值可能会直接影响 leveldb 的写入性能。
  ...
  // 快速判断某一个 key 是否在 sstable 中，通常是使用 Bloom Filter 这一 “假阳性” 的算法
